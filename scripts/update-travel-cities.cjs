...
const newCities = [
  ...
  { city: '苏格兰', slug: 'scotland', country: '英国', emoji: '🏴', year: '2019', lat: 56.0, lng: -3.7, description: '从爱丁堡城堡踞守的死火山岩，到格拉斯哥维多利亚时代的红砖街巷——苏格兰用一种苍凉而粗犷的美，把中世纪的记忆、高地的风、和工业时代的幽默一起装进了这块土地。', attractions: [{ name: '爱丁堡城堡', description: '死火山 Castle Rock 的顶端，这座城堡已经守卫了爱丁堡近千年。', highlight: true }, { name: '荷里路德修道院', description: '十二世纪奥古斯丁修道院的遗迹，高耸的哥特式花窗如今只剩下石框。' }, { name: '乔治广场', description: '格拉斯哥市中心的心脏，维多利亚女王骑马雕像矗立在高大的花岗岩基座上。', highlight: true }, { name: '格拉斯哥大教堂', description: '苏格兰唯一一座在中世纪宗教改革中幸存下来的大教堂。' }, { name: '格拉斯哥现代艺术美术馆', description: '新古典主义柱廊，门廊前的威灵顿公爵骑马雕像戴着标志性的橙色交通锥。' }], photos: ['/scotland/IMG_5224.jpg','/scotland/IMG_5229.jpg','/scotland/IMG_5272.jpg','/scotland/IMG_5274.jpg','/scotland/IMG_5282.jpg','/scotland/IMG_5367.jpg','/scotland/IMG_5415.jpg'] },
